    ...
    <div class="min-h-screen bg-mesh">
      <div class="px-6 py-16 mx-auto max-w-7xl lg:px-8">
        ...
        <div class="mb-16 page-transition">
          ...
          <p class="max-w-2xl text-xl text-gray-600">Branding and visual design projects that make lasting impressions.</p>
        </div>
...
const graphicsProjects = [
  {
    ...
    tags: [
      { name: 'Illustrator', class: 'bg-pink-100 text-pink-600' },
      { name: 'Brand Strategy', class: 'bg-orange-100 text-orange-600' },
      { name: 'Logo Design', class: 'bg-red-100 text-red-600' }
    ]
  },
  {
    id: 2,
    ...
    tags: [
      { name: 'Photoshop', class: 'bg-pink-100 text-pink-600' },
      { name: 'Motion Graphics', class: 'bg-yellow-100 text-yellow-600' },
      { name: 'Canva', class: 'bg-rose-100 text-rose-600' }
    ]
  },
  {
    id: 3,
    ...
    tags: [
      { name: 'InDesign', class: 'bg-pink-100 text-pink-600' },
      { name: 'Typography', class: 'bg-purple-100 text-purple-600' },
      { name: 'Print Design', class: 'bg-orange-100 text-orange-600' }
    ]
  }
]
</script>
